...
=====================================================
*/
static void mjOpt2_Set( mjOpt2 opt, char* value )
{
    // set default value 
...
===================================================================
*/
bool mjOpt2_Define( char* section, char* key, int type, void* value,
            char* defaultValue )
{
    // sanity check
...
==============================================================
*/
bool mjOpt2_SetValue( char* section, char* key, char* value )
{
    char* global = "global";
...
===============================================
*/
bool mjOpt2_ParseConf( const char* fileName )
{
    ...
    while ( 1 ) {
        ...
        mjStrList_Delete( strList );
        // set option value
        mjOpt2_SetValue( section, key, value );
    }
